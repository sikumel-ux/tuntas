...
function cekSessionWarga() {
    ...
    if (savedKey && savedData) {
        ...
        // SETTING FILTER LANGSUNG KE TANGGAL 1 BULAN BERJALAN
...
async function muatKasMasyarakat() {
    ...
    // Hitung saldo secara kronologis maju dari data paling awal
    keys.forEach(key => {
        const v = data[key];
    ...
    // Balik urutan key agar inputan terbaru berada di atas saat di-render
