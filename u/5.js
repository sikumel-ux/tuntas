...
function bukaDetailSampahKalender(tanggal, jam, status) {
    document.getElementById('dtlSampahTgl').innerText = `${tanggal} Juni 2026`;
...
function salinNorekKeClipboard() {
    const teksNorek = document.getElementById('norekSaku').innerText;
    navigator.clipboard.writeText(teksNorek).then(() => {
